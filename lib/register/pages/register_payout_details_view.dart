            ...
            child: SingleChildScrollView(
              child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    TextFormField(
                      initialValue: driver.confirmAccountNumber,
                      decoration: const InputDecoration(
                          isDense: true,
                          labelText: "Confirm Account Number"),
                      onChanged: (value) => driver.confirmAccountNumber = value,
                    ),
                    const SizedBox(height: 8),
                    TextFormField(
                      initialValue: driver.bankSwift,
                      decoration: const InputDecoration(
                          isDense: true, labelText: 'Bank Branch'),
              ...
              builder: (RunMutation runMutation, QueryResult? result) {
                return SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      if(driver.bankName != null && driver.bankSwift!=null && driver.bankRoutingNumber != null && driver.accountNumber != null){
