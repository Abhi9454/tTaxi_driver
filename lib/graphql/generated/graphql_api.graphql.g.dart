...
GetMessages$Query$Driver$Order _$GetMessages$Query$Driver$OrderFromJson(
    ...
    GetMessages$Query$Driver$Order()
      ...
      ..rider = json['rider'] == null
          ? null
          : GetMessages$Query$Driver$Order$Rider.fromJson(
              json['rider'] as Map<String, dynamic>)
      ..driver = json['driver'] == null
          ? null
          : GetMessages$Query$Driver$Order$Driver.fromJson(
...
History$Query$OrderConnection$OrderEdge$Order$Service
    _$History$Query$OrderConnection$OrderEdge$Order$ServiceFromJson(
            Map<String, dynamic> json) =>
        History$Query$OrderConnection$OrderEdge$Order$Service()
          ..name = json['name'] as String;

Map<String, dynamic>
    _$History$Query$OrderConnection$OrderEdge$Order$ServiceToJson(
            History$Query$OrderConnection$OrderEdge$Order$Service instance) =>
        <String, dynamic>{
          'name': instance.name,
        };

History$Query$OrderConnection$OrderEdge$Order
    _$History$Query$OrderConnection$OrderEdge$OrderFromJson(
            Map<String, dynamic> json) =>
        History$Query$OrderConnection$OrderEdge$Order()
          ..id = json['id'] as String
          ...
          ..service = json['service'] == null
              ? null
              : History$Query$OrderConnection$OrderEdge$Order$Service.fromJson(
                  json['service'] as Map<String, dynamic>);

Map<String, dynamic> _$History$Query$OrderConnection$OrderEdge$OrderToJson(
    History$Query$OrderConnection$OrderEdge$Order instance) {
  final val = <String, dynamic>{
    'id': instance.id,
...
History$Query$OrderConnection$OrderEdge
    _$History$Query$OrderConnection$OrderEdgeFromJson(
            Map<String, dynamic> json) =>
        History$Query$OrderConnection$OrderEdge()
          ..node = History$Query$OrderConnection$OrderEdge$Order.fromJson(
              json['node'] as Map<String, dynamic>);

Map<String, dynamic> _$History$Query$OrderConnection$OrderEdgeToJson(
        History$Query$OrderConnection$OrderEdge instance) =>
    <String, dynamic>{
      'node': instance.node.toJson(),
    };

History$Query$OrderConnection$PageInfo
    _$History$Query$OrderConnection$PageInfoFromJson(
            Map<String, dynamic> json) =>
        History$Query$OrderConnection$PageInfo()
          ...
          ..startCursor =
              fromGraphQLConnectionCursorNullableToDartStringNullable(
                  json['startCursor'] as String?)
          ..hasPreviousPage = json['hasPreviousPage'] as bool?;

Map<String, dynamic> _$History$Query$OrderConnection$PageInfoToJson(
    History$Query$OrderConnection$PageInfo instance) {
  final val = <String, dynamic>{};
...
History$Query$OrderConnection _$History$Query$OrderConnectionFromJson(
    ...
    History$Query$OrderConnection()
      ..edges = (json['edges'] as List<dynamic>)
          .map((e) => History$Query$OrderConnection$OrderEdge.fromJson(
              e as Map<String, dynamic>))
          .toList()
      ..pageInfo = History$Query$OrderConnection$PageInfo.fromJson(
...
BasicProfileMixin$Order _$BasicProfileMixin$OrderFromJson(
    ...
    BasicProfileMixin$Order()
      ...
      ..rider = json['rider'] == null
          ? null
          : CurrentOrderMixin$Rider.fromJson(
              json['rider'] as Map<String, dynamic>)
      ..driverLastSeenMessagesAt = fromGraphQLTimestampToDartDateTime(
          json['driverLastSeenMessagesAt'] as int)
      ..conversations = (json['conversations'] as List<dynamic>)
...
Map<String, dynamic> _$BasicProfileMixin$OrderToJson(
  ...
  writeNotNull('rider', instance.rider?.toJson());
  val['driverLastSeenMessagesAt'] =
      fromDartDateTimeToGraphQLTimestamp(instance.driverLastSeenMessagesAt);
  val['conversations'] = instance.conversations.map((e) => e.toJson()).toList();
  return val;
}
...
CurrentOrderMixin$OrderMessage _$CurrentOrderMixin$OrderMessageFromJson(
    ...
    CurrentOrderMixin$OrderMessage()
      ..sentAt = fromGraphQLTimestampToDartDateTime(json['sentAt'] as int);
...
GetStats$Query$OrderConnection$OrderEdge$Order$Service
    _$GetStats$Query$OrderConnection$OrderEdge$Order$ServiceFromJson(
            Map<String, dynamic> json) =>
        GetStats$Query$OrderConnection$OrderEdge$Order$Service()
          ..name = json['name'] as String;

Map<String, dynamic>
    _$GetStats$Query$OrderConnection$OrderEdge$Order$ServiceToJson(
            GetStats$Query$OrderConnection$OrderEdge$Order$Service instance) =>
        <String, dynamic>{
          'name': instance.name,
        };

GetStats$Query$OrderConnection$OrderEdge$Order
    _$GetStats$Query$OrderConnection$OrderEdge$OrderFromJson(
            Map<String, dynamic> json) =>
        GetStats$Query$OrderConnection$OrderEdge$Order()
          ..id = json['id'] as String
          ..status = $enumDecode(_$OrderStatusEnumMap, json['status'],
          ...
          ..service = json['service'] == null
              ? null
              : GetStats$Query$OrderConnection$OrderEdge$Order$Service.fromJson(
                  json['service'] as Map<String, dynamic>);

Map<String, dynamic> _$GetStats$Query$OrderConnection$OrderEdge$OrderToJson(
    GetStats$Query$OrderConnection$OrderEdge$Order instance) {
  final val = <String, dynamic>{
    'id': instance.id,
    'status': _$OrderStatusEnumMap[instance.status]!,
    'createdOn': fromDartDateTimeToGraphQLTimestamp(instance.createdOn),
...
GetStats$Query$OrderConnection$OrderEdge
    _$GetStats$Query$OrderConnection$OrderEdgeFromJson(
            Map<String, dynamic> json) =>
        GetStats$Query$OrderConnection$OrderEdge()
          ..node = GetStats$Query$OrderConnection$OrderEdge$Order.fromJson(
              json['node'] as Map<String, dynamic>);

Map<String, dynamic> _$GetStats$Query$OrderConnection$OrderEdgeToJson(
        GetStats$Query$OrderConnection$OrderEdge instance) =>
    <String, dynamic>{
      'node': instance.node.toJson(),
    };

GetStats$Query$OrderConnection$PageInfo
    _$GetStats$Query$OrderConnection$PageInfoFromJson(
            Map<String, dynamic> json) =>
        GetStats$Query$OrderConnection$PageInfo()
          ..hasNextPage = json['hasNextPage'] as bool?
          ..endCursor = fromGraphQLConnectionCursorNullableToDartStringNullable(
...
Map<String, dynamic> _$GetStats$Query$OrderConnection$PageInfoToJson(
    GetStats$Query$OrderConnection$PageInfo instance) {
  final val = <String, dynamic>{};
...
GetStats$Query$OrderConnection _$GetStats$Query$OrderConnectionFromJson(
    ...
    GetStats$Query$OrderConnection()
      ..edges = (json['edges'] as List<dynamic>)
          .map((e) => GetStats$Query$OrderConnection$OrderEdge.fromJson(
              e as Map<String, dynamic>))
          .toList()
      ..pageInfo = GetStats$Query$OrderConnection$PageInfo.fromJson(
          json['pageInfo'] as Map<String, dynamic>);
...
AvailableOrders$Query$Order _$AvailableOrders$Query$OrderFromJson(
    ...
    AvailableOrders$Query$Order()
      ...
      ..service = json['service'] == null
          ? null
          : AvailableOrderMixin$Service.fromJson(
              json['service'] as Map<String, dynamic>)
      ..points = (json['points'] as List<dynamic>)
          .map((e) =>
              AvailableOrderMixin$Point.fromJson(e as Map<String, dynamic>))
